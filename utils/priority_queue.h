...
inline static void _PQSwim(void * const PQ, const size_t index, const size_t elemSize,
...
inline static void * PQDelete(void * const PQ, size_t * const end, const size_t elemSize,
                              bool (*compare)(const void * const, const void * const))
{
  char * const pq  = PQ;
